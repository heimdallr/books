...
private: // IUiFactory
	...
	[[nodiscard]] QMessageBox::ButtonRole ShowCustomDialog(const QString & title, const QString & text, const std::vector<std::pair<QMessageBox::ButtonRole, QString>> & buttons, QMessageBox::ButtonRole defaultButton) const override;
