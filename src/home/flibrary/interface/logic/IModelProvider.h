...
public:
	...
	[[nodiscard]] virtual std::shared_ptr<QAbstractItemModel>     CreateTreeModel(IDataItem::Ptr data) const        = 0;
	[[nodiscard]] virtual std::shared_ptr<QAbstractItemModel>     CreateBookListModel(IDataItem::Ptr data) const    = 0;
	[[nodiscard]] virtual std::shared_ptr<QAbstractItemModel>     CreateBookTreeModel(IDataItem::Ptr data) const    = 0;
	[[nodiscard]] virtual std::shared_ptr<QAbstractItemModel>     CreateAuthorsListModel(IDataItem::Ptr data) const = 0;
	[[nodiscard]] virtual std::shared_ptr<QAbstractItemModel>     CreateSearchListModel(IDataItem::Ptr data) const  = 0;
