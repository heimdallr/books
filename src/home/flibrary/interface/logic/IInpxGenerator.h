...
public:
	...
	virtual void ExtractAsInpxCollection(QString inpxFileName, const std::vector<QString>& idList, const class IBookInfoProvider& dataProvider, Callback callback) = 0;
