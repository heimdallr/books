...
{
public:
	static constexpr auto BOOKS_QUERY_FIELDS = "b.BookID, b.Title, coalesce(b.SeqNumber, -1), b.UpdateDate, b.LibRate, b.Lang, f.FolderTitle, b.FileName || b.Ext, b.BookSize, coalesce(bu.userRate, 0), coalesce(bu.IsDeleted, b.IsDeleted, 0), b.FolderID";
