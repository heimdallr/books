...
class ICommand;
template<typename T> int BindImpl(ICommand & command, size_t index, T value) = delete;
template<typename T> int BindImpl(ICommand & command, std::string_view name, T value) = delete;
template <typename T>
...
template<> inline int BindImpl(ICommand & command, const size_t index, const std::string_view value)
{
...
template<> inline int BindImpl(ICommand & command, const std::string_view name, const std::string_view value)
{
