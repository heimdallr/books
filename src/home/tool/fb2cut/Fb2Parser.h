...
public:
	static constexpr const char* FB2_TAGS[] {
		"p",          "fictionbook", "description", "body",      "binary",    "title-info", "src-title-info", "document-info", "publish-info", "custom-info", "genre",    "author",
		"first-name", "last-name",   "middle-name", "nickname",  "email",     "home-page",  "book-title",     "annotation",    "poem",         "cite",        "subtitle", "empty-line",
		"keywords",   "date",        "coverpage",   "image",     "lang",      "src-lang",   "translator",     "sequence",      "program-used", "src-url",     "src-ocr",  "id",
		"version",    "history",     "book-author", "book-name", "publisher", "city",       "year",           "isbn",          "title",        "epigraph",    "section",  "v",
		"a",          "text-author", "strong",      "emphasis",  "sub",       "sup",        "strikethrough",  "code",          "stanza",       "i",           "b",        "u",
		"table",      "tr",          "td",          "th",        "img",       "pre",        "style",          "center",        "h1",           "h2",          "h3",       "h4",
		"h5"
	};
