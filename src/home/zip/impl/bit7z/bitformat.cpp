...
const BitInOutFormat SevenZip(
	...
	FormatFeatures::MultipleFiles | FormatFeatures::SolidArchive | FormatFeatures::CompressionLevel | FormatFeatures::Encryption | FormatFeatures::HeaderEncryption | FormatFeatures::MultipleMethods
);
