...
#endif
const BitInOutFormat
	Zip(0x01, BIT7Z_STRING(".zip"), BitCompressionMethod::Deflate, FormatFeatures::MultipleFiles | FormatFeatures::CompressionLevel | FormatFeatures::Encryption | FormatFeatures::MultipleMethods);
const BitInOutFormat BZip2(0x02, BIT7Z_STRING(".bz2"), BitCompressionMethod::BZip2, FormatFeatures::CompressionLevel);
...
const BitInOutFormat SevenZip(0x07,
                              BIT7Z_STRING(".7z"),
                              BitCompressionMethod::Lzma2,
                              FormatFeatures::MultipleFiles | FormatFeatures::SolidArchive | FormatFeatures::CompressionLevel | FormatFeatures::Encryption | FormatFeatures::HeaderEncryption
...
const BitInOutFormat Xz(0x0C,
                        BIT7Z_STRING(".xz"), // NOLINT(*-identifier-length)
                        BitCompressionMethod::Lzma2,
