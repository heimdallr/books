...
// In C++98 and C++03 code the alternative spelling __final can be used instead (this is a GCC extension.)
	...
	#if defined(__cplusplus) && __cplusplus >= 201103L || defined(_MSC_VER) && _MSC_VER >= 1800 || defined(__clang__) && __clang_major__ >= 4
	/* || defined(__GNUC__) && __GNUC__ >= 9 */
		#define Z7_final final
		#if defined(__clang__) && __cplusplus < 201103L
			#pragma GCC diagnostic ignored "-Wc++11-extensions"
		#endif
	#elif defined(__cplusplus) && __cplusplus >= 199711L && defined(__GNUC__) && __GNUC__ >= 4 && !defined(__clang__)
		#define Z7_final __final
	#else
		#define Z7_final
		#if defined(__clang__) && __clang_major__ >= 4 || defined(__GNUC__) && __GNUC__ >= 4
			#pragma GCC diagnostic ignored "-Wnon-virtual-dtor"
			#pragma GCC diagnostic ignored "-Wdelete-non-virtual-dtor"
		#endif
	#endif
	...
	#if defined(__cplusplus) && (__cplusplus >= 201103L) || defined(_MSC_VER) && (_MSC_VER >= 1400) /* && (_MSC_VER != 1600) */ \
...
// typedef void (*Z7_void_Function)(void);
	...
	#define Z7_GET_PROC_ADDRESS(func_type, hmodule, func_name) Z7_CAST_FUNC(func_type, GetProcAddress(hmodule, func_name))
...
// || defined(__GNUC__)
	...
	#ifdef __clang__
		#define Z7_PURE_INTERFACES_BEGIN _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wnon-virtual-dtor\"")
_Pragma("GCC diagnostic ignored \"-Wweak-vtables\"")
		#define Z7_PURE_INTERFACES_END _Pragma("GCC diagnostic pop")
	#else
