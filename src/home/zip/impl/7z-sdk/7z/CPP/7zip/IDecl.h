...
#define Z7_DECL_IFACE_7ZIP_SUB(i, _base, groupId, subId)                                                                           \
	Z7_DEFINE_GUID(IID_##i, k_7zip_GUID_Data1, k_7zip_GUID_Data2, k_7zip_GUID_Data3_Common, 0, 0, 0, (groupId), 0, (subId), 0, 0); \
	struct Z7_DECLSPEC_NOVTABLE i : public _base

#define Z7_DECL_IFACE_7ZIP(i, groupId, subId) Z7_DECL_IFACE_7ZIP_SUB(i, IUnknown, groupId, subId)
...
#define Z7_IFACE_DECL_PURE(name) DECLARE_INTERFACE(name) { Z7_IFACE_PURE(name) };

#define Z7_IFACE_DECL_PURE_(name, baseiface) DECLARE_INTERFACE_(name, baseiface) { Z7_IFACE_PURE(name) };
