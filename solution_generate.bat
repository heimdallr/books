...
if [%BUILD_TYPE%]==[Debug] (
    set CONAN_PROFILE=%~dp0src\ext\scripts\conan\profiles\%CONAN_PROFILE%_debug
) else (
    set CONAN_PROFILE=%~dp0src\ext\scripts\conan\profiles\%CONAN_PROFILE%_release
)
