...
* Навигацию можно фмльтровать, не только искать в ней
* Массовое (>50К) извлечение книг работает
* Можно увидеть все книги коллекции в одном списке
...
* Поддерживается загрузка внешних qss, а также dll с вкомпилированными в них таблицами стилей
* Умеет в OPDS
* Развивается
#### Недостатки
...
* Нет тулбара
* Меньше настроек
* Нет украинского языка. Приглашаю к сотрудничеству
