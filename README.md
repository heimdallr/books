...
[^4]: Подтянутся из conan, если необходимо - соберутся локально. Кроме Qt6, который хочется свежий, а в конане древний LTS. Так что ожидаем переменную среды QT_PATH с путём к Qt6, как в старые добрые.
