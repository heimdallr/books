...
#### Пример запуска
```
fb2cut.exe D:\fb2.Flibusta.Net\*.zip -q 20 -f D:\repacked --max-width 480 --max-height 480 -a "C:\Program Files\7-Zip\7z.exe" --ffmpeg C:\programs\ffmpeg\6.0\bin\ffmpeg.exe
```
