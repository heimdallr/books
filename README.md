...
Используем их с FLibrary вместо исходных. Или с любым другим каталогизатором, который поддерживает указанный формат архивации, но книги будут без обдлжек и иллюстраций.
...
#### А что так долго-то?
Кодирование изображений в JPEG XL + 7z-архивация fb2.
...
* 7z.exe, для сборки портабельной версии.  
...
[^3]: Подтянутся из conan, если необходимо - соберутся локально
