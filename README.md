...
Добудьте где-нибудь imagequant.dll (у меня в релизном архиве или соберите сами по какой-нибудь инструкции в интернете), положите в D:\sdk\imagequant\x64\bin\. Или задайте свой путь к SDK в переменной окружения SDK_PATH. Если не собираетесь запускать fb2cut, то на imagequant.dll можно забить. Закомментируйте в cmake-файлах все места, где он встречается, чтобы конфигуруровалось без ошибок. Да, слегка тупо, но терпеть осталось недолго.
